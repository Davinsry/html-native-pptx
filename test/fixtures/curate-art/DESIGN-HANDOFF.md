# 822c4ea6-7637-4526-a86f-3e5a61891929 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `biennale-curatorial-deck.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `biennale-curatorial-deck.html`
...
- A single self-contained `biennale-curatorial-deck.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `biennale-curatorial-deck.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `Telkomsel-Batik-Sans-Reconstructed.ttf.bak`

## Coding checklist for AI tools
1. Inspect `biennale-curatorial-deck.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
